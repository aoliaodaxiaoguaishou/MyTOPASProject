...
def write_common_config(filename, HLX, HLY, HLZ):
    """
    通用配置部分，只需要写一次
    """
    template_common = f"""
    ...
    s:Ph/Default/ForRegion/G4DNA/ActiveG4EmModelFromModule = "g4em-dna"#g4em-dna,g4em-dna_opt2,g4em-dna-stationary_opt2
...
def append_cell_config(filename, cell_number, x, y, z, nucleus_radius, nucleus_radiusX, nucleus_radiusY, nucleus_radiusZ):
    ...
    #### Radionuclide Source for Cell {cell_number} ####
    s:So/RadionuclideSource{cell_number}/Type = "Volumetric"
    s:So/RadionuclideSource{cell_number}/Component = "Cytoplasm{cell_number}"
    #s:So/RadionuclideSource{cell_number}/Component = "Membrane{cell_number}"
    s:So/RadionuclideSource{cell_number}/ActiveMaterial = "G4_Lu"
    b:So/RadionuclideSource{cell_number}/RecursivelyIncludeChildren = "T"
    i:So/RadionuclideSource{cell_number}/NumberOfHistoriesInRun = 264
    #i:So/RadionuclideSource{cell_number}/NumberOfHistoriesInRun = 92
    i:So/RadionuclideSource{cell_number}/MaxNumberOfPointsToSample = 10000000
    s:So/RadionuclideSource{cell_number}/BeamEnergySpectrumType    = "Discrete"
    #s:So/RadionuclideSource{cell_number}/BeamEnergySpectrumType    = "Continuous"
    s:So/RadionuclideSource{cell_number}/BeamParticle = "e-"
    dv:So/RadionuclideSource{cell_number}/BeamEnergySpectrumValues = 36 6.16401E-03 4.74678E-02  6.04010E-02 6.08830E-02 6.20877E-02 6.95470E-02 7.12428E-02 7.16460E-02 1.01705E-01 1.02187E-01 1.03392E-01 1.10851E-01 1.12950E-01 1.25480E-01 1.25962E-01 1.27166E-01 1.34626E-01 1.36725E-01 1.42884E-01 1.84192E-01 1.97121E-01 1.97603E-01 1.98808E-01 2.06267E-01 2.08366E-01 2.38429E-01 2.38911E-01 2.40116E-01 2.47575E-01 2.49674E-01 2.55834E-01 3.10071E-01 3.10553E-01 3.11758E-01 3.19217E-01  3.21316E-01 MeV
    uv:So/RadionuclideSource{cell_number}/BeamEnergySpectrumWeightsUnscaled = 36 1.09753E-03 5.17072E-02 1.18801E-04 4.13544E-05 5.09951E-05 4.84520E-05 2.68020E-04 1.34486E-05 5.52802E-03 3.47404E-02 3.06777E-02 1.77125E-02 4.81564E-03 3.04142E-05 1.03191E-04 8.49289E-05 5.42269E-05 1.48186E-05 5.97023E-03 1.91324E-04 7.69803E-04 1.23382E-04 1.19152E-04 2.31783E-04 6.60486E-05 2.25367E-05 3.53928E-05 2.30467E-05 1.97518E-05 5.45466E-06 6.25701E-05 9.04148E-06 1.13696E-06 7.87446E-07 2.52035E-06 7.27062E-07
    uv:So/RadionuclideSource{cell_number}/BeamEnergySpectrumWeights = 6.46152 * So/RadionuclideSource{cell_number}/BeamEnergySpectrumWeightsUnscaled
    """
...
def create_cells_in_box(n, HLX, HLY, HLZ, cell_radius_x, cell_radius_y, cell_radius_z, nucleus_radius, nucleus_radiusX, nucleus_radiusY, nucleus_radiusZ):
    """
    ...
    write_common_config(filename, HLX, HLY, HLZ)
...
nucleus_radiusY = 8.5
nucleus_radiusZ = 1.9
create_cells_in_box(n_cells, HLX, HLY, HLZ, cell_radius_x, cell_radius_y, cell_radius_z, nucleus_radius, nucleus_radiusX, nucleus_radiusY, nucleus_radiusZ)
