...
private:
	...
	G4double fVoxelAdd; // 新增变量，用于扩大体素的体积
	G4int fHilbertCurveLayer;
	G4int fHilbertCurve3DRepeatX;
    G4int fHilbertCurve3DRepeatY;
    G4int fHilbertCurve3DRepeatZ;   
	...
	G4double fNucleusRadiusX;
	G4double fNucleusRadiusY;
	G4double fNucleusRadiusZ;
