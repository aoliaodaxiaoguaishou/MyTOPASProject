...
def append_cell_config(filename, cell_number, x, y, z, nucleus_radius, nucleus_radiusX, nucleus_radiusY, nucleus_radiusZ):
    ...
    i:So/RadionuclideSource{cell_number}/NumberOfHistoriesInRun = 1763
    #i:So/RadionuclideSource{cell_number}/NumberOfHistoriesInRun = 615
